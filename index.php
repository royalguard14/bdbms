...
console.log(response);
 ...
 additionalFields = `
        ...
        <input type="number" name="amount_budget" id="amount_budget" class="form-control" required placeholder="Enter the budget amount" step="0.01" min="0" max="${parsedResponse.remainingbudget}">
